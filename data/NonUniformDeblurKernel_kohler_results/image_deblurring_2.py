...
# existing code
    ...
    psnr = peak_signal_noise_ratio(initial_image, output_img)
    ssim = structural_similarity(initial_image, output_img, channel_axis=2)
    print(f"----\n{img_name}\nPSNR: {psnr}\nSSIM: {ssim}\n")
...
# new code to save PSNR and SSIM in a text file
    metrics_filename = os.path.join(args.output_folder, 'output_metrics.txt')
